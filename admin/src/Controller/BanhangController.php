...
/**
 * Banhang controller class.
 *
 * @since  1.6
 */
class BanhangController extends FormController
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Banhang', '', array());

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_banhangs&view=banhangs' . $this->getRedirectToListAppend(), false));
