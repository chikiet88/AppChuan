...
/**
 * Methods supporting a list of banhang records.
 *
 * @since  1.6
 */
class BanhangsModel extends ListModel
{
	/**
	 * Constructor.
	 *
			...
			$subQuery = $db->getQuery(true)
				...
				->where(
					[
						...
						$db->quoteName('asso1.context') . ' = ' . $db->quote('com_banhangs.item'),
					]
				);
			...
			$subQuery = $db->getQuery(true)
				...
				->where(
					[
						...
						$db->quoteName('type_alias') . ' = ' . $db->quote('com_banhangs.banhang'),
					]
				);
			...
			$query->join(
				...
				->where(
					[
						...
						$db->quoteName('tagmap.type_alias') . ' = ' . $db->quote('com_banhangs.banhang'),
					]
				)
