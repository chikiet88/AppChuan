...
/**
 * Banhangs Component Category Model
 *
 * @since  1.5
 */
class CategoryModel extends ListModel
{
	...
	/**
	 * Array of banhangs in the category
	 *
	 * @var    \stdClass[]
	 */
	...
	/**
	 * The list of other banhang categories.
	 *
	 * @var    array
	 */
	...
	public function getCategory()
	{
		if (!is_object($this->_item))
		{
			...
			$categories = Categories::getInstance('Banhangs', $options);
