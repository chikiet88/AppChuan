...
<?php else : ?>
	...
	<div class="com-banhangs-banhang banhang<?php echo $direction; ?>">
		...
		<?php if (isset($images->image_first) && !empty($images->image_first)) : ?>
			...
			<div class="com-banhangs-banhang__first-image img-intro-<?php echo htmlspecialchars($imgfloat, ENT_COMPAT, 'UTF-8'); ?>">
				<img
		...
		<?php if (isset($images->image_second) and !empty($images->image_second)) : ?>
			...
			<div class="com-banhangs-banhang__second-image float-<?php echo htmlspecialchars($imgfloat, ENT_COMPAT, 'UTF-8'); ?> item-image">
				<img
		...
		<?php if ($this->params->get('show_feed_description')) : ?>
			<div class="com-banhangs-banhang__description feed-description">
	  ...
	  <?php if ($this->rssDoc->image && $this->params->get('show_feed_image')) : ?>
			<div class="com-banhangs-banhang__feed-image">
		...
		<?php if (!empty($this->rssDoc[0])) : ?>
			<ol class="com-banhangs-banhang__items">
